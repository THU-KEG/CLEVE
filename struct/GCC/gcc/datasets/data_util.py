...
def _rwr_trace_to_dgl_graph(
    ...
    subg = _add_edge_and_node_data(g, subg)
...
def _add_edge_and_node_data(g, subg):
    p_eid = subg.parent_eid
    p_nid = subg.parent_nid
    subg.ndata['token_ids'] = g.ndata['token_ids'][p_nid]
    subg.edata['type'] = g.edata['type'][p_eid]
    return subg
